...
public class FlatObservableCollectionTests
{
    ...
    [TestFixture]
    public class WhenSectionsAdded
    {
        [Test]
        [TestCase(new[] { 4 })]
        ...
        {
            var events = new List<NotifyCollectionChangedEventArgs>();
            var items = new ObservableRangeCollection<int[]>(new[] { new[] { 1, 2 }, new[] { 3 } });
    ...
    [TestFixture]
    public class WhenSectionInserted
    {
        [Test]
        [TestCase(0, new[] { 4 })]
        [TestCase(1, new[] { 4, 4 })]
    ...
    [TestFixture]
    public class WhenSectionsRemoved
    {
        [Test]
        [TestCase(0, 1)]
        [TestCase(1, 1)]
        ...
        {
            var events = new List<NotifyCollectionChangedEventArgs>();
            var items = new ObservableRangeCollection<int[]>(new[] { new[] { 1, 2 }, new[] { 3 }, new[] { 4, 5, 6 } });
            var flatIndex = GetFlatSectionIndex(items, index);
    ...
    [TestFixture]
    public class WhenSectionsReplaced
    {
        [Test]
        [TestCase(new[] { 4 })]
        [TestCase(new[] { 4 }, new[] { 4 })]
    ...
    [TestFixture]
    public class WhenSectionsMoved
    {
        [Test]
        [TestCase(0, 1)]
        [TestCase(1, 1)]
        ...
        {
            var events = new List<NotifyCollectionChangedEventArgs>();
            var items = new ObservableCollection<int[]>(new[] { new[] { 1, 2 }, new[] { 3 }, new[] { 4, 5, 6 } });
    ...
    public class WhenItemsAdded
    {
        ...
        public void AddEventShouldBeRaised(int section, params int[] newItems)
        {
            ...
            var items = new ObservableRangeCollection<ObservableRangeCollection<int>>
            {
                new()
                {
                    1, 2
    ...
    [TestFixture]
    public class WhenItemsReplaced
    {
        [Test]
        [TestCase(0)]
        [TestCase(1, 7, 8)]
    ...
    public class WhenItemsMoved
    {
        ...
        public void MoveEventShouldBeRaised(int section, int oldIndex, int newIndex)
        {
            ...
            var items = new ObservableCollection<ObservableCollection<int>>
            {
                new()
                {
                    1, 2
    ...
    [TestFixture]
    public class WhenSeveralOperationsPerformedInSequence
    {
        [Test]
        public void OutputCollectionShouldBeCorrect()
        {
            ...
            items.Add(new ObservableRangeCollection<int> { 3, 4, 5, 6 });
